...
MEMORY_COMPILE_TASK = (
    "This is your memory-compile pass — a self-task (like the daily blog), not "
    "a cron. Compile the accumulated daily logs into durable knowledge pages "
    "under /data/memory/knowledge/. Read "
